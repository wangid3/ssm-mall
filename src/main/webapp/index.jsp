		...
		<div id="head">
            ...
            <div id="body" style="clear:left">
                <dl class="content">
					<dt></dt>
					<dd>
						<a target="_blank" href="trade_pay.jsp"><span>long code</span></a>
					</dd>
					
					<dt></dt>
					<dd>
						<a target="_blank" href="trade_precreate.jsp"><span>second code</span></a>
					</dd>
					
					<dt></dt>
					<dd>
						<a target="_blank" href="./trade_query.jsp"><span>order select</span></a>
					</dd>
					
					<dt></dt>
					<dd>
						<a target="_blank" href="./trade_refund.jsp"><span>order goback</span></a>
					</dd>
                </dl>
            </div>
